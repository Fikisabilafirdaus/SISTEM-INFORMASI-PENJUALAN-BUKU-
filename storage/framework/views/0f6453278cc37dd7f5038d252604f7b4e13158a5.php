            ...
            <div class="polished-sidebar bg-light col-12 col-md-3 col-lg-2 p-0 collapse d-md-inline" id="sidebar-nav">
                <ul class="polished-sidebar-menu ml-0 pt-4 p-0 d-md-block">
                    <input class="border-dark form-control d-block d-md-none mb-4" type="text" placeholder="Search"
                        aria-label="Search" />
                    <li><a href="<?php echo e(route('home')); ?>"><span class="oi oi-home"></span>
                            Home</a></li>
                    <li><a href="<?php echo e(route('users.index')); ?>"><span class="oi oi-people"></span>
                            Manage Users</a></li>
                    <li><a href="<?php echo e(route('categories.index')); ?>"><span class="oi oi-tag"></span>
                            Manage Categories</a></li>
                    <li><a href="<?php echo e(route('books.index')); ?>"><span class="oi oi-book"></span>
                            Manage Books</a></li>
                    <li><a href="<?php echo e(route('orders.index')); ?>"><span class="oi oi-inbox"></span>
                            Manage Orders</a></li>
...
<?php /**PATH C:\xampp\htdocs\toko-buku\resources\views/layouts/global.blade.php ENDPATH**/ ?>