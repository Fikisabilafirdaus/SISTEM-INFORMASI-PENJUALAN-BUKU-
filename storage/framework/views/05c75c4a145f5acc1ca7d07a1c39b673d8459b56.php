            ...
            <div class="row pl-3">
                ...
                <div class="col-md-6 col-lg-3 col-12 mb-2 col-sm-6">
                    <div class="media shadow-sm p-0 bg-white rounded text-primary ">
                        ...
                        <div class="media-body p-2">
                            <h6 class="media-title m-0">TOTAL PENGGUNA</h6>
                ...
                <div class="col-md-6 col-lg-3 col-12 mb-2 col-sm-6">
                    <div class="media shadow-sm p-0 bg-success-lighter text-light rounded">
                        ...
                        <div class="media-body p-2">
                            <h6 class="media-title m-0">KATEGORI</h6>
                            <div class="media-text">
                ...
                <div class="col-md-6 col-lg-3 col-12 mb-2 col-sm-6">
                    <div class="media shadow-sm p-0 bg-info-lighter text-light rounded ">
                        ...
                        <div class="media-body p-2">
                            <h6 class="media-title m-0">TOTAL PEMESANAN</h6>
                            <div class="media-text">
...
<?php echo $__env->make('layouts.global', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\toko-buku\resources\views/home.blade.php ENDPATH**/ ?>