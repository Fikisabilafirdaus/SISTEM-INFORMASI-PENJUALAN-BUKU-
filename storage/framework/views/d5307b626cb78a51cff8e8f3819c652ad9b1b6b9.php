        ...
        <div class="row">
            <div class="col-md-6">
                <form action="<?php echo e(route('books.index')); ?>">
                    <div class="input-group">
                        <input name="keyword" type="text" value="<?php echo e(Request::get('keyword')); ?>" class="form-control"
            ...
            <div class="col-md-6">
                <ul class="nav nav-pills card-header-pills">
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(Request::get('status') == NULL && Request::path() == 'books' ? 'active' : ''); ?>"
                            href="<?php echo e(route('books.index')); ?>">All</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(Request::get('status') == 'publish' ? 'active' : ''); ?>"
                            href="<?php echo e(route('books.index', ['status' => 'publish'])); ?>">Publish</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(Request::get('status') == 'draft' ? 'active' : ''); ?>"
                            href="<?php echo e(route('books.index', ['status' => 'draft'])); ?>">Draft</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(Request::path() == 'books/trash' ? 'active' : ''); ?>"
                            href="<?php echo e(route('books.trash')); ?>">Trash</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <table class="table table-bordered table-stripped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?php echo e(route('books.edit', [$book->id])); ?>" class="btn btn-sm btn-info">Edit</a>
...
<?php echo $__env->make('layouts.global', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\toko-buku\resources\views/books/index.blade.php ENDPATH**/ ?>