...
<div class="row">
    <div class="col-md-8">
        ...
        <form action="<?php echo e(route('books.store')); ?>" method="POST" enctype="multipart/form-data" class="shadow-sm p-3 bg-white">
        
            <?php echo csrf_field(); ?>

            <label for="title">Title</label><br>
            <input type="text" class="form-control <?php echo e($errors->first('title') ? "is-invalid" : ""); ?>" name="title" placeholder="Book title" value="<?php echo e(old('title')); ?>">
...
<script>
    $("#categories").select2({
        ajax: {
            url: "<?php echo e(asset('/')); ?>ajax/categories/search",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.global', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\toko-buku\resources\views/books/create.blade.php ENDPATH**/ ?>